						...
						<tbody>
							...
							?>
									<tr>
										...
										<td align='center'>
											<a href="goods_requisition_appr/approve_display/<?php echo $r->request_no;?>" class="btn btn-xs btn-success tooltips" data-placement="top" data-original-title="Display" title="Display" ><i class='fa fa-eye'></i> Display</a>
										</td>
